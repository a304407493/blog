					...
					<div class="panel-body">
						<ul>
							...
							<?php foreach ($new_arts as $new_art) { ?>
								<li>
									<a href="<?php echo $blog_art_url;?>?artid=<?php echo $new_art['artid'] ;?>">
					...
					<div class="panel-body">
						<ul>
							<?php foreach ($cats as $cat) { ?>
								<li>
									<a href="<?php echo $index_url;?>?catid=<?php echo $cat['catid'] ;?>">
					...
					<div class="panel-body">
						<ul>
							<?php foreach ($tags as $tag) { ?>
								<li>
									<a href="<?php echo $index_url;?>?catid=<?php echo $tag['tag'] ;?>">
										<?php echo $tag['tag']; ?>
									</a>
								</li>
							<?php } ?>
